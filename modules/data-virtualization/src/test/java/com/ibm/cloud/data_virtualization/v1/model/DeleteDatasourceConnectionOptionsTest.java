...
/**
 * Unit test class for the DeleteDatasourceConnectionOptions model.
 */
public class DeleteDatasourceConnectionOptionsTest {
  ...
  public void testDeleteDatasourceConnectionOptionsError() throws Throwable {
    new DeleteDatasourceConnectionOptions.Builder().build();
  }
