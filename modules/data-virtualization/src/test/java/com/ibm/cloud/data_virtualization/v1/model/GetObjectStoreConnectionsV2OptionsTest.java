...
/**
 * Unit test class for the GetObjectStoreConnectionsV2Options model.
 */
public class GetObjectStoreConnectionsV2OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetObjectStoreConnectionsV2Options() throws Throwable {
    GetObjectStoreConnectionsV2Options getObjectStoreConnectionsV2OptionsModel = new GetObjectStoreConnectionsV2Options.Builder()
      ...
      .build();
    assertEquals(getObjectStoreConnectionsV2OptionsModel.jwtAuthUserPayload(), "testString");
  }
}