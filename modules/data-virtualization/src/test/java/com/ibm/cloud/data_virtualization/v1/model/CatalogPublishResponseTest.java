...
/**
 * Unit test class for the CatalogPublishResponse model.
 */
public class CatalogPublishResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCatalogPublishResponse() throws Throwable {
    CatalogPublishResponse catalogPublishResponseModel = new CatalogPublishResponse();
    assertNull(catalogPublishResponseModel.getDuplicateAssets());
    assertNull(catalogPublishResponseModel.getFailedAssets());
    assertNull(catalogPublishResponseModel.getPublishedAssets());
  }
}