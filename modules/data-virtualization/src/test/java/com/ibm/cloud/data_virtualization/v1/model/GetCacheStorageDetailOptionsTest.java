...
/**
 * Unit test class for the GetCacheStorageDetailOptions model.
 */
public class GetCacheStorageDetailOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetCacheStorageDetailOptions() throws Throwable {
    GetCacheStorageDetailOptions getCacheStorageDetailOptionsModel = new GetCacheStorageDetailOptions();
    assertNotNull(getCacheStorageDetailOptionsModel);
  }
}