...
/**
 * Unit test class for the ListDatasourceConnectionsOptions model.
 */
public class ListDatasourceConnectionsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListDatasourceConnectionsOptions() throws Throwable {
    ListDatasourceConnectionsOptions listDatasourceConnectionsOptionsModel = new ListDatasourceConnectionsOptions();
    assertNotNull(listDatasourceConnectionsOptionsModel);
  }
}