...
/**
 * Unit test class for the CheckPolicyStatusV2Options model.
 */
public class CheckPolicyStatusV2OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCheckPolicyStatusV2Options() throws Throwable {
    CheckPolicyStatusV2Options checkPolicyStatusV2OptionsModel = new CheckPolicyStatusV2Options();
    assertNotNull(checkPolicyStatusV2OptionsModel);
  }
}