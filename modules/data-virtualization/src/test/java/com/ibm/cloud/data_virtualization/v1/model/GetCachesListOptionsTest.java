...
/**
 * Unit test class for the GetCachesListOptions model.
 */
public class GetCachesListOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetCachesListOptions() throws Throwable {
    GetCachesListOptions getCachesListOptionsModel = new GetCachesListOptions();
    assertNotNull(getCachesListOptionsModel);
  }
}